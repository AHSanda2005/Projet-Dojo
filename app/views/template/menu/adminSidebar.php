                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu submenu-closed" style="--submenu-height: 86px;">
                        <li class="submenu-item  ">
                            <a href="<?= Flight::base() ?>/" class="submenu-link">dashboard</a>
                        </li>
                        <li class="submenu-item  ">
                            <a href="<?= Flight::base() ?>/" class="submenu-link">stock matériel</a>
                        </li>
                        <li class="submenu-item  ">
                            <a href="<?= Flight::base() ?>/" class="submenu-link">suivi salle</a>
                        </li>
                    </ul>
                </li>  
